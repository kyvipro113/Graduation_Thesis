...
# Form implementation generated from reading ui file 'GUI/Design/UI_MedicalRecord.ui'
#
...
class Ui_MedicalRecord(object):
    def setupUi(self, MedicalRecord):
        ...
        self.btView.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
...
if __name__ == "__main__":
    ...
    MedicalRecord = QtWidgets.QFrame()
    ui = Ui_MedicalRecord()
    ui.setupUi(MedicalRecord)
    MedicalRecord.show()
    sys.exit(app.exec_())
