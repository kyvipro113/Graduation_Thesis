...
# Form implementation generated from reading ui file 'GUI/Design/UI_MedicalRegister.ui'
#
...
class Ui_MedicalRegister(object):
    def setupUi(self, MedicalRegister):
        ...
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.txtOld)
        ...
        self.formLayout_2.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.txtNumberPhone)
        ...
        self.formLayout_2.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.txtCitizenID)
        ...
        self.formLayout_2.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.txtIDHealthInsurance)
        ...
        self.formLayout_2.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.txtDiagnoseRequest)
        ...
        self.formLayout_2.setWidget(4, QtWidgets.QFormLayout.FieldRole, self.comboFaculty)
        ...
        self.formLayout_2.setWidget(5, QtWidgets.QFormLayout.FieldRole, self.comboEmployee)
        self.deTime = QtWidgets.QDateEdit(MedicalRegister)
        font = QtGui.QFont()
        font.setPointSize(12)
        self.deTime.setFont(font)
        self.deTime.setObjectName("deTime")
        self.formLayout_2.setWidget(6, QtWidgets.QFormLayout.FieldRole, self.deTime)
        ...
        self.dataTabMedicalRegister.setSizeAdjustPolicy(QtWidgets.QAbstractScrollArea.AdjustToContents)
...
if __name__ == "__main__":
    ...
    MedicalRegister = QtWidgets.QFrame()
    ui = Ui_MedicalRegister()
    ui.setupUi(MedicalRegister)
    MedicalRegister.show()
    sys.exit(app.exec_())
